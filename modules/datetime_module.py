import datetime  #  built-in datetime module to perform date calculations.
...
birthdate = datetime.datetime.strptime(input("Input your birthdate (YYYY-MM-DD): "), "%Y-%m-%d")

# Subtracts the {birthdate} from today's date, resulting in a timedelta object
current_age = datetime.datetime.today() - birthdate
